...
class LiveView extends Component {
  ...
  drawBbox(trackedItem) {
    ...
    let x = trackedItem.x - trackedItem.w / 2
    let y = trackedItem.y - trackedItem.h / 2
    context.strokeRect(
    x + 5,
    y + 5,
    trackedItem.w - 10,
    ...
    context.fillText(
        trackedItem.idDisplay,
        x + trackedItem.w / 2 - 20,
        y + trackedItem.h / 2
    )
  }
        ...
        if(this.lastFrameData) {
          ...
          thisFrameData = thisFrameData.map((trackedItem) => {
            ...
            if(lastFrameTrackedItem) {
              ...
              // Todo scale trackedItem to canvas
              this.drawBbox(trackedItem);
