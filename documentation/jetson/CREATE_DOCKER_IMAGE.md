...
# Tag your image
sudo docker tag <IMAGEID> opendatacam/opendatacam:v3.0.0-alpha.1-nano

# Or for tx2 : opendatacam/opendatacam:v3.0.0-alpha.1-tx2
# Or for xavier : opendatacam/opendatacam:v3.0.0-alpha.1-xavier

# Push image
sudo docker push opendatacam/opendatacam:v3.0.0-alpha.1-nano


# (optional) Useful Untag image (if you made a tipo)
sudo docker rmi opendatacam/opendatacam:v3.0.0-alpha.1-nano
```
